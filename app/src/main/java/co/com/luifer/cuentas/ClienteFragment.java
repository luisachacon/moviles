...
public class ClienteFragment extends Fragment {
    ...
    @Override public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        llenarCliente= new ArrayList<>();
        View view=inflater.inflate(R.layout.fragment_cliente, container, false);
        recycler= view.findViewById(R.id.clientes_lista);
        recycler.setLayoutManager(new LinearLayoutManager(getActivity()));

        llenarClientes();
        AdapterCliente adapter=new AdapterCliente((llenarCliente));
    ...
    private void llenarClientes() {
        ...
        llenarCliente.add(new LlenarDatosCliente("Bella"));
        llenarCliente.add(new LlenarDatosCliente("Maria"));
        llenarCliente.add(new LlenarDatosCliente("Edilmar"));
        llenarCliente.add(new LlenarDatosCliente("Paola"));
    }
